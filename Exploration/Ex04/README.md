...
- [ O ] **2. 전체 코드에서 가장 핵심적이거나 가장 복잡하고 이해하기 어려운 부분에 작성된
      ...
      "# 마스크는 유지하되 배경은 블러처리를 한 이후 concat하여서 고양이에 집중된 사진을 만듭니다." 등
...
- [ O ] **3. 에러가 난 부분을 디버깅하여 문제를 해결한 기록을 남겼거나
      ...
      인물 세그멘테이션 관련 오류 해결중이었던 것으로 보입니다.
...
코드는 매우 간결하고, 함수화와 모듈화 등이 적절히 적용되어 있습니다.
      ![image](./ref/ref3.png)
...
```
간결한 코드가 인상적이었습니다.
인물 세그멘테이션 부분에서 오류가 발생한 이유가 무엇인지 파악하시면 좋을 것 같습니다.